...
export function Movement() {
  return (
    <section className="px-5 py-8 pb-12">
      ...
      <h2 className="mb-4 text-[22px] font-[800] tracking-[-0.01em] text-slate-950">{CONTENT.movement.title}</h2>
      <p className="text-[13px] leading-[1.8] text-slate-700">{CONTENT.movement.body}</p>
    </section>
  );
}
