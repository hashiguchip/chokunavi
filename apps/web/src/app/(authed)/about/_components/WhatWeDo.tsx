    ...
    <section className="px-5 py-8">
      ...
      <div className="flex flex-col gap-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          <div className="mb-2 flex h-9 w-9 items-center justify-center rounded-[10px] bg-primary-50 font-mono text-body-small font-bold text-primary-500">
            01
          </div>
          <div className="mb-1.5 text-sm font-bold text-slate-950">マッチング</div>
          <div className="text-body-small leading-[1.7] text-slate-500">
